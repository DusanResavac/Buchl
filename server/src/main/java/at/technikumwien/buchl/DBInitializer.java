...
public class DBInitializer {
    ...
    public void handleApplicationReady() {
        ...
        authorRepository.saveAll(List.of(
                new Author("Kugane", "Maruyama", "KuganeMaruyama.webp", /*"Eine Person mit überzogener schwarzen Weste, die eine Brille und eine schwarze Skelett Maske trägt"*/null, null),
                ...
                new Author("Lew", "Tolstoi", "tolstoj.jpg", /*"Ein sehr bärtiger alter Mann auf einem Stuhl in einem Park oder Wald sitzend."*/null, null),
        ...
        bookRepository.saveAll(List.of(
                new Book("Overlord, Vol. 9 (Light Novel): The Caster of Destruction", englisch, 256, LocalDate.of(2019, 01, 22), "Jedes Jahr bricht ein Konflikt zwischen dem Königreich und dem Kaiserreich aus, der in der Regel nur mit einem Patt endet. Aber wenn der Herrscher des Reiches, der Frischblutkaiser Jircniv, das Große Grab von Nazarick besucht, wird Ainz in den Kampf eingreifen und das Grenzscharmützel in einen totalen Krieg verwandeln!", kugane, "overlord 9.jpg", "Bildbeschreibung: Ein Herrscherskelett mit einer roten Flagge und eine Armee aus bewaffneten Skeletten auf dem Schlachtfeld.", "738054365-2"),
                new Book("Overlord, Vol. 10 (Light Novel): The Ruler of Conspiracy", englisch, 256, LocalDate.of(2019, 05, 21), "Nachdem er das Königreich der Dunkelheit gegründet hat, ist Ainz entschlossen, es in eine Utopie zu verwandeln - einen Ort, an dem viele Rassen und Kreaturen unendlichen Wohlstand genießen können. Sein erster Schritt auf dem Weg zu diesem Ziel ist der Ausbau der Abenteurergilde und die Ausbildung von Abenteurern, was ihn dazu bringt, dem Kaiserreich einen Besuch abzustatten! Andernorts sind die regionalen Anführer durch das plötzliche Auftauchen des Königreichs der Finsternis verunsichert und schmieden schnell ihre eigenen Pläne, wie sie mit der aufstrebenden Nation umgehen wollen... Ainz' erste Aktionen als Herrscher eines unsterblichen Königreichs haben gerade erst begonnen!", kugane, "overlord 10.jpg", "Bildbeschreibung: Ein Skelett im Magiergewand mit einem Zepter steht in der Arena eines stark besuchten Kolosseums.", "468559864-4"),
                ...
                new Book("Nathan der Weise", deutsch, 160, LocalDate.of(2005, 9, 1),
                        "Die Szene ist Jerusalem zur Zeit der Kreuzzüge. Spannungsreich treffen die drei Weltreligionen Christentum, Judentum und Islam aufeinander. Inmitten eines dramatischen Geschehens um die Rettung seiner Tochter durch einen christlichen Ordensritter, den seinerseits der Sultan vor dem Tod bewahrt hat, steht Nathan der Weise als ruhender Pol der Vernunft, Aufklärung und Toleranz. In der berühmten Ringparabel klärt er die heikle Frage nach der wahren Religion. Keine der drei Weltreligionen ist absolut. Jede erweist ihre Wahrheit und ihren Sinn erst durch die Kraft, mit der sie praktische Humanität stiften kann. Nathan gelingt es, die Menschen verschiedenen Glaubens in friedvollem Miteinander als Angehörige einer großen Familie zu vereinen.\n" +
                                "\n" +
                                "Gotthold Ephraim Lessing, geb. 1729 in Kamenz/Oberlausitz, kam als Pfarrerssohn und drittes von zwölf Kindern zur Welt. Nach dem Abitur studierte er zunächst Theologie, wandte sich aber bald den philologischen Fächern zu. Der Schriftsteller arbeitete als Dramaturg für das Hamburger Nationaltheater und verfasste zahlreiche berühmte Werke. Privat hatte Lessing 1777/78 sowohl den Tod seines Sohnes als auch den seiner Frau zu verkraften. Er starb am 15. Februar 1781 vereinsamt in Braunschweig. Die Uraufführung seines \"Nathan\" im Jahr 1783 erlebte er nicht mehr. Als bedeutendster Dichter, Denker und Kritiker der Aufklärung, dessen Genialität sogar Goethe bewunderte, gilt er heute als erster moderner Autor Deutschlands.\n", gotthold, "nathan der weise.webp", "Bildbeschreibung: Ein älterer Herr in einem lockeren Gewand mit einem überzogenen gelben Tuch auf der Schulter.", "257098272-5"),
                ...
                new Book("Oliver Twist (Roman)", deutsch, 416, LocalDate.of(2012, 1, 31), "Als Findelkind im Armenhaus einer englischen Kleinstadt aufgewachsen, flüchtet sich der junge Oliver Twist aus den Fängen seines brutalen Lehrherrn nach London. Doch im Moloch der Großstadt gerät er bald an den skrupellosen Hehler Fagin, der ein seltsames Interesse daran zu haben scheint, Oliver in die Welt des Verbrechens hineinzuziehen ... Wegen seiner präzisen Milieuschilderungen und seines entwaffnenden Sinns für skurrile Komik zählt \"Oliver Twist\" bis heute zu den bedeutendsten und beliebtesten Romanen der englischsprachigen Literatur. (Dickens, Charles 1812 - 1870)", dickens, "oliver twist.jpg", "Bildbeschreibung: Ein Junge in einem älteren, düsteren und finsteren England.", "797305090-6"),
                ...
                new Book("Die Grabräuber", deutsch, 240, LocalDate.of(2022, 10, 24), "", tolstoi, null, null, "32452356")
        ));
        ...
        Discussion d9 = new Discussion(
                "Passendes Buch für 12 jährige Nichte?",
        ...
        try (BufferedReader reader =
                     new BufferedReader(
                             new InputStreamReader(
                                     this.getClass().getResourceAsStream("/rating_data.csv")))) {
